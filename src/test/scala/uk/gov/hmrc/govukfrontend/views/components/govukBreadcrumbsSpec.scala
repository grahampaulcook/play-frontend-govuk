...
class govukBreadcrumbsSpec extends TemplateUnitSpec[Breadcrumbs]("govukBreadcrumbs") {
  ...
  "breadcrumb" should {
    ...
    "render the attributes in order" in {
      ...
      component.body should startWith("<div class=\"govuk-breadcrumbs \" id=\"my-navigation\" role=\"navigation\">")
    }
    ...
    "render the attributes in order when input is reversed" in {
      ...
      component.body should startWith("<div class=\"govuk-breadcrumbs \" role=\"navigation\" id=\"my-navigation\">")
    }
  }
}
